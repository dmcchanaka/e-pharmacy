                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12 form-group text-center">
                            <table class="table table-bordered" id="main_tbl">
                                <tr>
                                    ...
                                    <td>:</td>
                                    <td class="text-left">
                                        {{$permissionGroup->per_gp_name}}
                                        <input type="hidden" class="form-control form-control-sm" id="per_group" name="per_group" value="{{$permissionGroup->per_gp_id}}" />
                                    </td>
                                    <td class="text-left">USER TYPE</td>
                                    <td>:</td>
                                    <td class="text-left">
                                        {{$permissionGroup->getUserType()}}
                                        <input type="hidden" class="form-control form-control-sm" id="u_tp_id" name="u_tp_id" value="{{$permissionGroup->u_tp_id}}" />
                                    </td>
                                </tr>
                            </table>
                        </div>
    ...
    <div class="row">
        ...
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
            ...
            <div class="accrodion-regular">
                ...
                @php $main_count++; $main_status = 0; @endphp
                @if($item['added_permission_id'] !="" && $item['main_permission_id'] == $item['added_permission_id']) 
                @php $main_status = 1; @endphp
                @endif
                    <div class="card mb-2">
                        <div class="card-header" id="headingEight">
                            <div class="dd-handle" style="padding: .0rem 1rem; border-top: 0px solid rgba(19, 29, 40, .125); border-bottom: 0px solid rgba(19, 29, 40, .125) !important">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-12 col-sm-8 col-lg-6 pt-1">
                                            <div class="switch-button switch-button-danger switch-button-xs">
                                                <input type="checkbox" @if($item['added_permission_id'] !="" && $item['main_permission_id'] == $item['added_permission_id']) {{"checked"}} @endif name="switch_{{$main_count}}" id="switch_{{$main_count}}" onclick="toggleMainSection({{ $main_count }})" />
                                                <span>
                                            ...
                                            <input type="hidden" id="main_sec_status_{{$main_count}}" name="main_sec_status_{{$main_count}}" value="{{$main_status}}" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div id="collapse_{{$item['main_permission_id']}}" class="collapse" aria-labelledby="headingEight" data-parent="#accordion3">
                            ...
                            <section class="card card-fluid">
                                <div class="dd" id="nestable2">
                                    ...
                                    @php $sub_count++; $sub_status = 0; @endphp
                                    @if($sub_sec['added_sub_permission_id'] !="" && $sub_sec['sub_sec_id'] == $sub_sec['added_sub_permission_id']) 
                                        @php $sub_status = 1; @endphp
                                    @endif
                                        <li class="dd-item" data-id="15">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-12 col-sm-9 col-lg-6 pt-1" style="padding-right:25px">
                                                            <div class="switch-button switch-button switch-button-xs">
                                                                <input type="checkbox" @if($sub_sec['added_sub_permission_id'] !="" && $sub_sec['sub_sec_id'] == $sub_sec['added_sub_permission_id']) {{"checked"}} @endif name="switch_{{$main_count}}_{{$sub_count}}" id="switch_{{$main_count}}_{{$sub_count}}" onclick="toggleSubSection({{$main_count}},{{$sub_count}})">
                                                                <span>
                                                            ...
                                                            <input type="hidden" id="sub_sec_status_{{$main_count}}_{{$sub_count}}" name="sub_sec_status_{{$main_count}}_{{$sub_count}}" value="{{$sub_status}}" />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="dd-handle"> 
                                                        <div class="col-md-12" style="border: 1px solid #c2c2c2;height:auto; background-color:#f3f3f3">
                                                            <div class="row mb-6" style="margin-bottom:-20px">
                                                                ...
                                                                @php $bottom_count++; $bottom_status = 0; @endphp
                                                                @if($btm['added_bottom_permission_id'] !="" && $btm['bottom_sec_id'] == $btm['added_bottom_permission_id']) 
                                                                    @php $bottom_status = 1; @endphp
                                                                @endif
                                                                    ...
                                                                    <div class="form-group row">
                                                                        ...
                                                                        <div class="col-12 col-sm-4 col-lg-4 pt-1">
                                                                            <div class="switch-button switch-button-success switch-button-xs">
                                                                                <input type="checkbox" @if($btm['added_bottom_permission_id'] !="" && $btm['bottom_sec_id'] == $btm['added_bottom_permission_id']) {{"checked"}} @endif name="switch_{{$main_count}}_{{$sub_count}}_{{$bottom_count}}" id="switch_{{$main_count}}_{{$sub_count}}_{{$bottom_count}}" onclick="toggleBottomSection({{$main_count}},{{$sub_count}},{{$bottom_count}})">
                                                                                <span>
                                                                            ...
                                                                            <input type="hidden" id="bottom_sec_status_{{$main_count}}_{{$sub_count}}_{{$bottom_count}}" name="bottom_sec_status_{{$main_count}}_{{$sub_count}}_{{$bottom_count}}" value="{{$bottom_status}}" />
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                @endforeach
                                            ...
                                            <ol class="dd-list">
                                                ...
                                                @foreach ($sub_sec['bottom_section'] AS $btm)
                                                @php $bottom_count_new++; $bottom_status = 0; @endphp
                                                @if($btm['added_bottom_permission_id'] !="" && $btm['bottom_sec_id'] == $btm['added_bottom_permission_id']) 
                                                    @php $bottom_status = 1; @endphp
                                                @endif
                                                <li class="dd-item" data-id="15">
                                                <div class="dd-handle" style="padding: .15rem 1rem !important">
                                                    ...
                                                    <div class="dd-nodrag btn-group ml-auto">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-12 col-sm-9 col-lg-6 pt-1" style="padding-right:25px">
                                                                <div class="switch-button switch-button switch-button-xs">
                                                                    <input type="checkbox" @if($btm['added_bottom_permission_id'] !="" && $btm['bottom_sec_id'] == $btm['added_bottom_permission_id']) {{"checked"}} @endif name="switch_{{$main_count}}_{{$sub_count}}_{{$bottom_count_new}}" id="switch_{{$main_count}}_{{$sub_count}}_{{$bottom_count_new}}" onclick="toggleBottomSection({{$main_count}},{{$sub_count}},{{$bottom_count_new}})">
                                                                    <span>
                                                                ...
                                                                <input type="hidden" id="bottom_sec_status_{{$main_count}}_{{$sub_count}}_{{$bottom_count_new}}" name="bottom_sec_status_{{$main_count}}_{{$sub_count}}_{{$bottom_count_new}}" value="{{$bottom_status}}" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                        ...
                                                        <div class="dd-handle"> 
                                                            <div class="col-md-12" style="border: 1px solid #c2c2c2;height:auto; background-color:#f3f3f3">
                                                                <div class="row mb-6" style="margin-bottom:-20px">
                                                                    ...
                                                                    @php $fourth_count++; $fourth_status = 0; @endphp
                                                                    @if($fth['added_fourth_permission_id'] !="" && $fth['forth_sec_id'] == $fth['added_fourth_permission_id']) 
                                                                        @php $fourth_status = 1; @endphp
                                                                    @endif
                                                                    <div class="col-md-3 pb-3">
                                                                        <div class="form-group row">
                                                                            ...
                                                                            <div class="col-12 col-sm-4 col-lg-4 pt-1">
                                                                                <div class="switch-button switch-button-success switch-button-xs">
                                                                                    <input type="checkbox" @if($fth['added_fourth_permission_id'] !="" && $fth['forth_sec_id'] == $fth['added_fourth_permission_id']) {{"checked"}} @endif name="switch_{{$main_count}}_{{$sub_count}}_{{$bottom_count_new}}_{{$fourth_count}}" id="switch_{{$main_count}}_{{$sub_count}}_{{$bottom_count_new}}_{{$fourth_count}}" onclick="toggleForthSection({{$main_count}},{{$sub_count}},{{$bottom_count_new}},{{$fourth_count}})">
                                                                                    <span>
                                                                                ...
                                                                                <input type="hidden" id="fourth_sec_status_{{$main_count}}_{{$sub_count}}_{{$bottom_count_new}}_{{$fourth_count}}" name="fourth_sec_status_{{$main_count}}_{{$sub_count}}_{{$bottom_count_new}}_{{$fourth_count}}" value="{{$fourth_status}}" />
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    @endforeach
            ...
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                <div class="form-group">
                    <div class="">
                        ...
                        <button type="button" id="add" class="btn btn-primary btn-sm" onclick="form_submit('add', 'permission_edit_form')">Submit</button>
                    </div>
                </div>
            </div>
        </div>
