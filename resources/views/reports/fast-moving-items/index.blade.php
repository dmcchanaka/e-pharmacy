...
<div class="wrapper wrapper-content animated fadeInRight">
    ...
    <div class="row">
        <div class="col-lg-12">
            <div id="fast_moving_details"></div>
        </div>
    </div>
</div>
...
function search() {
            $.ajax({
                type: "POST",
                url: "{{ url('/reports/fast-moving-items/search') }}",
                data: {
                    "_token": "{{ csrf_token() }}",
                    'pro_id': $('#pro_id').val(),
                ...
                cache: false,
                beforeSend: function() { 
                    $("#fast_moving_details").html('<div style="text-align:center"><img class="logo-img" src="{{ asset('template/images/loading.gif') }}" style="height:100px;weight:100px"></div>');
                },
                success: function (html) {
                    $("#fast_moving_details").html('');
                    $("#fast_moving_details").html(html).show('slow');
                },
